...
void initRendering() {
	...
	Image* image = loadBMP("G:\\4.2\\CG Lab\\IndiaGate\\Road.bmp");
...
//	Other sizes of images might not work properly.
	...
	image = loadBMP("G:\\4.2\\CG Lab\\IndiaGate\\Grass.bmp");
	grassTex = loadTexture(image);
	delete image;

	image = loadBMP("G:\\4.2\\CG Lab\\IndiaGate\\side.bmp");
	sideTex = loadTexture(image);
	delete image;

	image = loadBMP("G:\\4.2\\CG Lab\\IndiaGate\\top.bmp");
	topTex = loadTexture(image);
	delete image;

	image = loadBMP("G:\\4.2\\CG Lab\\IndiaGate\\NightSky.bmp");
	nightSkyTex = loadTexture(image);
	delete image;

	image = loadBMP("G:\\4.2\\CG Lab\\IndiaGate\\texRoof1.bmp");
	texRoof1 = loadTexture(image);
	delete image;

	image = loadBMP("G:\\4.2\\CG Lab\\IndiaGate\\wall.bmp");
	wall = loadTexture(image);
	delete image;

	image = loadBMP("G:\\4.2\\CG Lab\\IndiaGate\\india.bmp");
